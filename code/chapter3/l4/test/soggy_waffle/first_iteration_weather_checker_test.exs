defmodule SoggyWaffle.WeatherCheckerTest do
  ...
  #file path -> example/test/weather_checker_with_mode_test.exs
#add this code at the indicated place mentioned in comments of example/test/weather_checker_with_mode_test
#in the playground widget 
 ...
 import Mox
  ...
  test "when the process \"ticks\", the Twilio interface is called" do
    ...
    assert_receive {:send_sms_called, ^ref},5000
  end
end