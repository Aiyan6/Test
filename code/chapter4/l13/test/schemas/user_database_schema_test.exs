defmodule TestingEcto.Schemas.UserDatabaseSchemaTest do
  ...
  describe "changeset/1" do
    ...
    test "error: returns error changeset when an email address is reused" do
      #file path -> testing_ecto/test/schemas/user_database_schema_test.exs
#add this code at the indicated place mentioned in comments of testing_ecto/test/schemas/user_database_schema_test.exs
