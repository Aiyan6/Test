...
#file path -> soggy_waffle/test/support/weather_api_test_router.ex
#add this code at the indicated place mentioned in comments of soggy_waffle/test/support/weather_api_test_router.ex
