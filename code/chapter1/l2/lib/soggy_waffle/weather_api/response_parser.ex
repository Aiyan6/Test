defmodule SoggyWaffle.WeatherAPI.ResponseParser do
 ...
 # Add response_parser.ex code here#file path -> soggy_waffle/lib/soggy_waffle/weather_api/response_parser.ex
#add this code at the indicated place mentioned in comments of soggy_waffle/lib/soggy_waffle/weather_api/response_parser.ex
#in the playground widget
  ...
  end#file path -> soggy_waffle/lib/soggy_waffle/weather_api/response_parser.ex
#add this code at the indicated place mentioned in comments of soggy_waffle/lib/soggy_waffle/weather_api/response_parser.ex
#in the playground widget
  @thunderstorm_ids [200, 201, 202, 210, 211, 212, 221, 230, 231, 232]
  @drizzle_ids [300, 301, 302, 310, 311, 312, 313, 314, 321]
